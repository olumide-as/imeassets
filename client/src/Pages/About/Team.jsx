        ...
        <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                ...
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685024478/imeassets/oladeji_williams_itpvl4.jpg"
                alt="Person"
              />
            </div>
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685024580/imeassets/osarume_sf5yol.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685025771/imeassets/bobby_takhng.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685024688/imeassets/muizz_mfg3sd.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685024852/imeassets/munachi_njeeg7.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1685024859/imeassets/margaretta_lwiuve.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
