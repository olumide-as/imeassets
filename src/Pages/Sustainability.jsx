      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" style={{ backgroundImage: `url(${'https://res.cloudinary.com/dz2fc3ioz/image/upload/v1688418302/imeassets/bg-fade_m8abj0.svg'})`, backgroundSize: "cover", backgroundPosition: "center", }}>
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            ...
            be confident that your Integrated Infrastructure Asset Management practices contribute to a
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" style={{ backgroundImage: `url(${'https://res.cloudinary.com/dz2fc3ioz/image/upload/v1688418302/imeassets/bg-fade_m8abj0.svg'})`, backgroundSize: "cover", backgroundPosition: "center", }}>
        ...
        <div className="grid gap-5 mb-8 md:grid-cols-2 lg:grid-cols-2">
          <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
            ...
            <h6 className="mb-2 font-semibold leading-5">Governance</h6>
            <p className="text-sm text-gray-900">
              Our Corporate Sustainability Committee oversees our policies and operational controls for environmental, health, safety, and social risks, and is led by the Executive Leadership.
          ...
          <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
            ...
            <h6 className="mb-2 font-semibold leading-5">Diversity and Inclusion</h6>
            <p className="text-sm text-gray-900">
              We embrace and value diversity in all its forms, whether gender, age, ethnicity or cultural background. Equal opportunity is integral to our recruitment process, as we aim to develop a community of diverse talent. We seek to maintain a positive workplace, free from discrimination and harassment. We promote an environment of fairness and equality. Our commitment to diversity and inclusion applies to the highest levels of the organization.
