      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" style={{ backgroundImage: `url(${'https://res.cloudinary.com/dz2fc3ioz/image/upload/v1688418302/imeassets/bg-fade_m8abj0.svg'})`, backgroundSize: "cover", backgroundPosition: "center", }}>
        <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            At the heart of our organization, our distinguished management team stands as a collective force of visionary leaders, guiding our journey to excellence in the field of Integrated Infrastructure Asset Management. With a wealth of experience, a passion for innovation, and a commitment to fostering a collaborative and inclusive work environment, our management team exemplifies the values and principles that drive our success.
          </p>
        </div>

        <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
          <div>
            <div className="relative pb-80 md:pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-contain md:object-cover object-top w-full h-full rounded "
          ...
          <div>
            <div className="relative pb-80 md:pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-contain md:object-cover object-top w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1691781095/imeassets/team/WhatsApp_Image_2023-08-11_at_15.51.01_kbm96y.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Lameen Abdul-Malik</p>
              <p className="mb-5 text-xs text-gray-800">Board Advisor</p>
              <div className="flex items-center space-x-3 sm:justify-center">
                <a
                  href="https://www.linkedin.com/in/lameen-abdul-malik/"
                  className="text-orange-700 transition-colors duration-300 hover:text-deep-purple-accent-400"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div>
            <div className="relative pb-80 md:pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-contain md:object-cover object-top w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1691781764/imeassets/team/WhatsApp_Image_2023-08-11_at_16.08.52_fk61lg.jpg"
                alt="Person"
              />
            </div>
          ...
          <div>
            <div className="relative pb-80 md:pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-contain md:object-cover object-top w-full h-full rounded"
                src="https://res.cloudinary.com/dz2fc3ioz/image/upload/v1691781978/imeassets/team/WhatsApp_Image_2023-08-11_at_15.51.54_zjx9tm.jpg"
                alt="Person"
              />
            </div>

            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Onaedo Etobe</p>
              <p className="mb-5 text-xs text-gray-800">Real Estate Management Lead</p>
              <div className="flex items-center space-x-3 sm:justify-center">
                <a
                  href="https://www.linkedin.com/in/onaedo-onyenorah-etobe/"
                  className="text-orange-700 transition-colors duration-300 hover:text-deep-purple-accent-400"
                  target="_blank"
                  rel="noopener noreferrer"
                >
